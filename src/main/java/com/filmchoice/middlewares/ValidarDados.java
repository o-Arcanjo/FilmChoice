...
import com.filmchoice.middlewares.ClasseBase;
...
public class ValidarDados <EntidadeBaseValidacao, EntidadeValidada>{
     ...
     */
    private boolean validarCadaPropriedade (ClasseBase classeBase){
        String nomeClasse = classeBase.getNomeClasse();
        String variavelClasse = classeBase.getCurrentVariavel();
        String valorVariavelClasse = classeBase.getCurrentValor();
     ...
     */
    private Boolean adicionarCampoValor(ClasseBase classeBase){
        String nomeClasse = classeBase.getNomeClasse();
        String variavelClasse = classeBase.getCurrentVariavel();
        String valorVariavelClasse = classeBase.getCurrentValor();
     ...
     */
    private <Entidade> boolean iterarCampos(Entidade entidade, Function<ClasseBase,Boolean> processador){
        ...
        for(Field campo : campos){
            ...
            try{
                ...
                ClasseBase classeBase = ClasseBase.builder()
                        .nomeClasse(nomeClasse)
                        .currentVariavel(variavel)
                        .currentValor(valor)
                        .build();
